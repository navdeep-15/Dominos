...
export class TabVegPizza extends React.PureComponent {
    constructor() {
        super();
        ...
        this.setState({
            data: [
                ...
                },
                {
                    ...
                    description: "Flavourful trio of juicy paneer, crisp capsicum with spicy red paprika ",
                },
                {
...
export default connect(mapStateToProps, mapDispatchToProps)(TabVegPizza);